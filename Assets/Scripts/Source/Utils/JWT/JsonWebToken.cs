...
namespace Source.Utils.JWT
{
    ...
    public static class JsonWebToken
    {
        ...
        /// <param name="payload">An arbitrary payload (must be serializable to JSON via <see cref="Serialization.JavaScriptSerializer"/>).</param>
        ...
        /// <summary>
        /// Given a JWT, decode it and return the payload as an object (by deserializing it with <see cref="Serialization.JavaScriptSerializer"/>).
        /// </summary>
        /// <param name="token">The JWT.</param>
        /// <param name="key">The key that was used to sign the JWT.</param>
        /// <param name="verify">Whether to verify the signature (default is true).</param>
